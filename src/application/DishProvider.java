...
public class DishProvider {
    ...
    public List<Dish> getDishes() {
        ...
        dishes.add(new Dish("Shepherd's Pie", "Minced meat topped with mashed potatoes and baked", RecipeList.getShepherdsPieSteps(), 45, "File:src/application/English_Flag.png", "English"));
        dishes.add(new Dish("Full English Breakfast", "Classic breakfast with eggs, bacon, sausage, beans, and more", RecipeList.getFullEnglishBreakfastSteps(), 25, "File:src/application/English_Flag.png", "English"));
        dishes.add(new Dish("Beef Wellington", "Beef fillet coated with pâté and wrapped in puff pastry", RecipeList.getBeefWellingtonSteps(), 60, "File:src/application/English_Flag.png", "English"));
        dishes.add(new Dish("Ploughman's Lunch", "Cold meal with cheese, bread, pickles, and more", RecipeList.getPloughmansLunchSteps(), 15, "File:src/application/English_Flag.png", "English"));
        dishes.add(new Dish("Bangers and Mash", "Sausages served with mashed potatoes and onion gravy", RecipeList.getBangersAndMashSteps(), 35, "File:src/application/English_Flag.png", "English"));
        dishes.add(new Dish("Cornish Pasty", "Pastry filled with meat, potatoes, and vegetables", RecipeList.getCornishPastySteps(), 40, "File:src/application/English_Flag.png", "English"));
        dishes.add(new Dish("Steak and Kidney Pie", "Pie filled with diced beef, kidney, and gravy", RecipeList.getSteakAndKidneyPieSteps(), 50, "File:src/application/English_Flag.png", "English"));
        dishes.add(new Dish("Eton Mess", "Dessert with strawberries, meringue, and whipped cream", RecipeList.getEtonMessSteps(), 20, "File:src/application/English_Flag.png", "English"));
        dishes.add(new Dish("Tea and Scones", "Traditional afternoon tea with scones and clotted cream", RecipeList.getTeaAndSconesSteps(), 15, "File:src/application/English_Flag.png", "English"));
